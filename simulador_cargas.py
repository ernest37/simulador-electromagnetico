...
# Validacion: Que no existan dos cargas en la misma posicion
...
with col2:
    ...
    if mostrar_mapa:
        if modo == "2D":
            ...
            ax.quiver(X_grid, Y_grid, Ex_grid, Ey_grid, color='lightgray', alpha=0.5, pivot='middle', scale=30)
        else:
            ...
            ax.quiver(X_grid, Y_grid, Ex_grid, Ey_grid, color='lightgray', alpha=0.5, pivot='middle', scale=25)
